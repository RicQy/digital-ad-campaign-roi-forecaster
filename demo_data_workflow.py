...
def demo_data_insights():
    ...
    platform_perf['roi'] = (platform_perf['revenue'] - platform_perf['spend']) / platform_perf['spend'] * 100
    platform_perf['ctr'] = platform_perf['clicks'] / df.groupby('platform')['impressions'].sum() * 100
...
def main():
    ...
    try:
        ...
        print(f"✅ Data validation: {'SUCCESS' if validation_result.is_valid else 'FAILED'}")
