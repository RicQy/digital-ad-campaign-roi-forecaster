...
from ad_roi_forecaster.visualization.plots import plot_spend_vs_conversions, plot_forecasted_conversions
...
def test_report_generator():
    ...
    assert report_gen.summary_stats['total_campaigns'] == len(df), "Total campaigns should match"
    assert report_gen.summary_stats['total_spend'] == df['spend'].sum(), "Total spend should match"
